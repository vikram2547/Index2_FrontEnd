...
//   const loginSelector = useSelector((state) => state.login.loginData?.department_admin);
  ...
  return (
    ...
    >
      ...
      >
        <div className="sidebar-inner slimscroll">
          <div id="sidebar-menu" className="sidebar-menu">
            {/* Display all menu items if login is false, otherwise show only QC Checked Files */}
            {!login ? (
              <ul className="sidebar-vertical" id="veritical-sidebar">
                <li className="menu-title">
                  <span>Home</span>
              ...
              <ul className="sidebar-vertical" id="veritical-sidebar">
                ...
                <li className="submenu">
                  <Link to="/app/main/userqcchecked-files">
                    <i className="la la-check-circle" />
                    <span> QC Checked Files</span>
                  </Link>
                </li>
